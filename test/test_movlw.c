...
void test_assemble_movlw_0x37_fff_expect_exception(void){
	CEXCEPTION_T ex;
	int machineCode;
...
void xtest_movlw_(void)
{
  ...
  IntegerToken intToken = {TOKEN_INTEGER_TYPE,11,4,"0x63"};

  initTokenizer_ExpectAndyReturn("   movlw  0x63    ",tokenizer);
