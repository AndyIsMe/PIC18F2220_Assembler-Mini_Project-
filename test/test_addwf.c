...
void test_ADDWF_addwf_0x37_coma_WREG_coma_ACCESS_expect_exception(void){
	CEXCEPTION_T ex;
	int machineCode;
  ...
  IdentifierToken ACCESSToken = {TOKEN_IDENTIFIER_TYPE, 21,6,"ACCESS"};
	...
	initTokenizer_ExpectAndReturn("   addwf   0x37,WREG,ACCESS  ",tokenizer);
  ...
  getToken_ExpectAndReturn(tokenizer, (Token *)&ACCESSToken);
	...
	Try {
		machineCode = addwf("   addwf   0x37,WREG,ACCESS  ");
...
void test_ADDWF_addwf_0x37_coma_WREG_coma_BANKED_expect_exception(void){
  ...
  IdentifierToken BANKEDToken = {TOKEN_IDENTIFIER_TYPE, 21,6,"BANKED"};
	...
	initTokenizer_ExpectAndReturn("   addwf   0x37,WREG,BANKED  ",tokenizer);
	getToken_ExpectAndReturn(tokenizer, (Token *)&addwfToken);//
	getToken_ExpectAndReturn(tokenizer, (Token *)&intToken);//
  getToken_ExpectAndReturn(tokenizer,(Token *)&opToken);
  getToken_ExpectAndReturn(tokenizer, (Token *)&WREGToken);
  ...
  getToken_ExpectAndReturn(tokenizer, (Token *)&BANKEDToken);
	...
	Try {
		machineCode = addwf("   addwf   0x37,WREG,BANKED  ");
		printf("the instruction opcode is %#4x",machineCode);
	}Catch(ex) {
		TEST_ASSERT_EQUAL(EXTRA_OPERAND, ex);
	}
...
void test_ADDWF_addwf_0x37_coma_f_coma_ACCESS_expect_exception(void){
	CEXCEPTION_T ex;
	int machineCode;
	Tokenizer *tokenizer = (Tokenizer *)0x0badface;
	IdentifierToken addwfToken = {TOKEN_IDENTIFIER_TYPE, 3,5,"addwf"};
  ...
  IdentifierToken ACCESSToken = {TOKEN_IDENTIFIER_TYPE, 18,6,"ACCESS"};
	...
	initTokenizer_ExpectAndReturn("   addwf   0x37,f,ACCESS  ",tokenizer);
	getToken_ExpectAndReturn(tokenizer, (Token *)&addwfToken);//
	getToken_ExpectAndReturn(tokenizer, (Token *)&intToken);//
  getToken_ExpectAndReturn(tokenizer,(Token *)&opToken);
  getToken_ExpectAndReturn(tokenizer, (Token *)&WREGToken);
  ...
  getToken_ExpectAndReturn(tokenizer, (Token *)&ACCESSToken);
	...
	Try {
		machineCode = addwf("   addwf   0x37,f,ACCESS  ");
		printf("the instruction opcode is %#4x",machineCode);
	}Catch(ex) {
		TEST_ASSERT_EQUAL(EXTRA_OPERAND, ex);
	}
...
void test_ADDWF_addwf_0x37_coma_f_coma_BANKED_expect_exception(void){
	CEXCEPTION_T ex;
	int machineCode;
	Tokenizer *tokenizer = (Tokenizer *)0x0badface;
	IdentifierToken addwfToken = {TOKEN_IDENTIFIER_TYPE, 3,5,"addwf"};
  ...
  IdentifierToken BANKEDToken = {TOKEN_IDENTIFIER_TYPE, 18,6,"BANKED"};
	...
	initTokenizer_ExpectAndReturn("   addwf   0x37,f,BANKED  ",tokenizer);
	getToken_ExpectAndReturn(tokenizer, (Token *)&addwfToken);//
	getToken_ExpectAndReturn(tokenizer, (Token *)&intToken);//
  getToken_ExpectAndReturn(tokenizer,(Token *)&opToken);
  getToken_ExpectAndReturn(tokenizer, (Token *)&WREGToken);
  ...
  getToken_ExpectAndReturn(tokenizer, (Token *)&BANKEDToken);
	...
	Try {
		machineCode = addwf("   addwf   0x37,f,BANKED  ");
		printf("the instruction opcode is %#4x",machineCode);
	}Catch(ex) {
		TEST_ASSERT_EQUAL(EXTRA_OPERAND, ex);
	}
